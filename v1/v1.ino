...
Default:
  ...
  // sensor function
  bool VerifTurnLeft() {
    return digitalRead(TopSensor) == LOW && digitalRead(MiddleRightSensor) == HIGH && digitalRead(LeftSensor) == HIGH && digitalRead(MiddleLeftSensor) == HIGH;
  }
  //FONCTIONS MOTEURS
...
>>>>>>> 8556913a07ea7a6c54f56fef7644790ab96402dc:main/main.ino
